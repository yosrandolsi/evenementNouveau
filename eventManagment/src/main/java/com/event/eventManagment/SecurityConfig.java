    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/categories/delete/**").hasRole("ADMIN")  // Seul ADMIN peut supprimer des catégories
                ...
                .requestMatchers("/api/events/create").hasAnyRole("ADMIN", "ORGANIZER")  // Seul ADMIN ou ORGANIZER peuvent créer un événement
                .requestMatchers("/api/events/update/**").hasRole("ADMIN")  // Seul ADMIN ou ORGANIZER peuvent mettre à jour un événement
                .requestMatchers("/api/events/delete/**").hasRole("ADMIN")  // Seul ADMIN peut supprimer un événement
